...
#define CNTVIDEO 4*512        // 一个数据包s_ppi_video_for_disp中所有的数据个数
...
//{
//    DISPMEMTYPE nfirst;//一次信息     一次视频对应的颜色值
//    DISPMEMTYPE nsecond;
//    DISPMEMTYPE nthird;
//	DISPMEMTYPE nmap;
//
//    VIDEODATATYPE first;//一次视频    雷达回波数据的幅度值，原始雷达数据被传进来之后，被放在first中，之后做余辉时，会对first进行衰减，所以first记录的不总是原始雷达数据
//    
//    //反映当前状态
