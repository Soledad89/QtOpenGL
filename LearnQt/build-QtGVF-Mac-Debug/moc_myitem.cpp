...
const QMetaObjectExtraData MyItem::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MyItem::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MyItem,
      qt_meta_data_MyItem, &staticMetaObjectExtraData }
};
